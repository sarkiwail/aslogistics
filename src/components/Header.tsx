  ...
  return (
    <>
      <header className={styles.header}>
        <div className={styles.container}>
          ...
          <div className={styles.actions}>
            ...
            <a href="https://wa.me/2348033616172" className={styles.whatsappBtn} target="_blank" rel="noopener noreferrer" aria-label="Chat on WhatsApp">
      ...
      <div className={`${styles.drawer} ${isMenuOpen ? styles.drawerOpen : ""}`}>
        ...
        <a
          href="https://wa.me/2348033616172"
