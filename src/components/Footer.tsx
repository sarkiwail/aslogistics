      ...
      <div className={styles.container}>
        <div className={styles.topRow}>
          ...
          <div className={styles.contact}>
            ...
            <a href="tel:08033616172" className={styles.contactLink}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
              </svg>
              <span>08033616172</span>
            </a>
            <p className={styles.contactText}>24/7 Fleet Contact</p>
          </div>
          ...
          <div className={styles.social}>
            ...
            <div className={styles.socialIcons}>
              <a href="https://wa.me/2348033616172" className={styles.socialIcon} aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
              ...
              <a href="#" className={styles.socialIcon} aria-label="Threads">
                <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
                  <path d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.509C2.35 18.44 1.5 15.586 1.472 12.01v-.017c.03-3.579.879-6.43 2.525-8.482C5.845 1.205 8.6.024 12.18 0h.014c2.746.02 5.043.725 6.826 2.098 1.677 1.29 2.858 3.13 3.509 5.467l-2.04.569c-1.104-3.96-3.898-5.984-8.304-6.015-2.91.022-5.11.936-6.54 2.717C4.307 6.504 3.616 8.914 3.589 12c.027 3.086.718 5.496 2.057 7.164 1.43 1.783 3.631 2.698 6.54 2.717 2.623-.02 4.358-.631 5.8-2.045 1.677-1.652 2.466-4.21 2.475-7.99h2.04c-.03 4.04-1.235 7.256-3.698 9.508-2.306 2.114-5.346 3.153-9.054 3.175zm-5.322-8.768v-.033c0-.938.145-1.744.433-2.415.278-.671.673-1.242 1.175-1.705.502-.464 1.101-.814 1.793-1.045.692-.23 1.47-.338 2.323-.338.89 0 1.66.113 2.306.338.646.226 1.24.567 1.785 1.02s.958.934 1.256 1.54c.298.607.444 1.291.444 2.058v.033c0 .767-.15 1.45-.447 2.057a5.884 5.884 0 0 1-1.256 1.54c-.545.453-1.14.794-1.785 1.02-.646.225-1.416.338-2.306.338-.852 0-1.631-.108-2.323-.338-.692-.23-1.29-.581-1.793-1.045-.502-.464-.897-1.034-1.175-1.705-.288-.671-.433-1.477-.433-2.415z" />
                </svg>
              </a>
